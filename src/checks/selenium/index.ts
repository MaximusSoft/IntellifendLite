...
export const checkSeleniumDocumentAttributes: Checker = {
  ...
  handler: async ({ log }) => {
    ...
    log.trace(
      BotRuntime.Selenium,
      'document_attributes',
      `document.documentElement.getAttributeNames must contains "selenium": ${JSON.stringify(
...
export const checkSeleniumDocumentProperties: Checker = {
  ...
  handler: async ({ log }) => {
    ...
    log.trace(
      BotRuntime.Selenium,
      'document_properties',
      `window.document must contains "selenium": ${JSON.stringify(documentProps)}`,
    )
    return includes(
      documentProps,
      'selenium',
...
export const checkSeleniumWindowProperties: Checker = {
  ...
  handler: async ({ log }) => {
    ...
    log.trace(
      BotRuntime.Selenium,
      'selenium_window_properties',
      `window properties must not contain '_selenium', '_Selenium_IDE_Recorder', 'callSelenium': ${contains}`,
    )
    return contains
  },
}
